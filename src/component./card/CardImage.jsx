...
const CardImage = () => {
  return (
    <div className="w-full sm:max-w-sm border h-fit border-gray-200 shadow-md rounded-lg bg-white  hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:border-gray-700 ">
      <a href="">
        <img src={aziz} alt="Image1" />
      </a>
      <div className="p-5">
